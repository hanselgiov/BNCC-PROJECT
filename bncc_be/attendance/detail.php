...
<div class="wrapper layout-top-nav">
  ...
  <div class="content-wrapper px-5">
    <div class="content-header">
      ...
      <div class="row mb-2">
      <div class="col-sm-12 ">
          <h1 class="mb-0 mt-2 mx-2 text-center">Detail User</h1>
      </div><!-- /.col -->
      </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  </div> <!-- /.content-header -->
        ...
        <form action="" method="post" enctype="multipart/form-data">  
                ...
                <div class="row mx-1 mt-2">         
                  ...
                  <div class="form-group col-4">
                        ...
                        <input type="text" class="form-control" placeholder="First Name" name="firstName" value="<?= $row['firstName'] ?>" readonly>
                    </div>
                    <div class="form-group col-4">
                        <label for="lastName">Last Name</label>
                        <input type="text" class="form-control" placeholder="Last Name" name="lastName" value="<?= $row['lastName'] ?>" readonly>
                    </div>
                    <div class="form-group col-4">
                        <label for="lastName">Email</label>
                        <input type="email" class="form-control" placeholder="Email" name="email" value="<?= $row['email'] ?>" readonly>
                    </div>
                  </div>
                  <div class="row mx-1 mb-1">
                    ...
                    <div class="form-group col-12">
                        ...
                        <textarea name="bio" class="form-control" id="bio" cols="100" rows="3" readonly><?= $row['bio'] ?></textarea>
                        <br>
